# Search e Indexing — Paquete de implementación backend

## 1. Propósito

Este paquete permite implementar **Search Query en core e Indexing como Azure Function** sin leer todo el set documental. Contiene las reglas mínimas de arquitectura, seguridad, datos, APIs, eventos, infraestructura Azure, pruebas y Definition of Done necesarias para el módulo.
...
El alcance incluido es: **búsqueda legal, búsqueda tenant, indexación documental, embeddings opcionales y filtros tenant**.
...
`SearchIndexItem, SearchQueryLog, IndexingJob`
