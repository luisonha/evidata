# Legal Knowledge — Paquete de implementación backend

## 1. Propósito

Este paquete permite implementar **fuentes legales, obligaciones, artículos, bases de licitud, derechos y taxonomías** sin leer todo el set documental. Contiene las reglas mínimas de arquitectura, seguridad, datos, APIs, eventos, infraestructura Azure, pruebas y Definition of Done necesarias para el módulo.
...
|---|---|
| Backend | .NET 10. |
| Estilo | core modular extraíble a futuro. |
...
El alcance incluido es: **catálogo legal versionado, obligaciones computables y taxonomías extendibles por tenant**.
...
Tipo arquitectónico: **core modular extraíble a futuro**.
...
`LegalSource, LegalSourceVersion, LegalArticle, LegalObligation, LegalBasis, DataCategory, DataSubjectCategory, SecurityMeasure`
