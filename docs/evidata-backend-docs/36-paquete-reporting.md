# Reporting — Paquete de implementación backend

## 1. Propósito

Este paquete permite implementar **Reporting Orchestration en core y Report Generation como Azure Function** sin leer todo el set documental. Contiene las reglas mínimas de arquitectura, seguridad, datos, APIs, eventos, infraestructura Azure, pruebas y Definition of Done necesarias para el módulo.
...
El alcance incluido es: **solicitud, generación y descarga de reportes RAT, brechas y evidence packs**.
...
`ReportJob, ReportArtifact, ReportDownloadLog`
