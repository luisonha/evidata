# Notificaciones y Maintenance Jobs — Paquete de implementación backend

## 1. Propósito

Este paquete permite implementar **Notification Delivery, Security Jobs y Maintenance Jobs** sin leer todo el set documental. Contiene las reglas mínimas de arquitectura, seguridad, datos, APIs, eventos, infraestructura Azure, pruebas y Definition of Done necesarias para el módulo.
...
|---|---|
| Backend | .NET 10. |
| Estilo | functions + orquestación mínima en core. |
...
El alcance incluido es: **envío de avisos, recordatorios, jobs programados, health checks operativos y alertas**.
...
Tipo arquitectónico: **functions + orquestación mínima en core**.
...
`NotificationRequest, NotificationDeliveryLog, MaintenanceJobRun, SecurityJobFinding`
