# RAT / Processing Inventory — Paquete de implementación backend

## 1. Propósito

Este paquete permite implementar **inventario de actividades de tratamiento, versionado, aprobación, flags y brechas automáticas** sin leer todo el set documental. Contiene las reglas mínimas de arquitectura, seguridad, datos, APIs, eventos, infraestructura Azure, pruebas y Definition of Done necesarias para el módulo.
...
El alcance incluido es: **núcleo funcional de Opción B: tratamientos, finalidades, bases legales, categorías, titulares, sistemas, proveedores, retención y medidas**.
...
`ProcessingActivity, ProcessingActivityVersion, ProcessingDataCategory, ProcessingVendor, ProcessingTransfer, ProcessingRiskFlag`
