...
public interface IUserProfileRepository
{
    ...
    Task<UserProfile?> GetByEmailAsync(string email, Guid tenantId, CancellationToken ct = default);
    Task<IReadOnlyList<UserProfile>> GetByTenantIdAsync(Guid tenantId, CancellationToken ct = default);
    Task<IReadOnlyList<UserProfile>> GetByRoleAndTenantAsync(Guid roleId, Guid tenantId, CancellationToken ct = default);
    Task<int> CountActiveTenantOwnersAsync(Guid tenantId, CancellationToken ct = default);
